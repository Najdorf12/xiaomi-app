...
const Card = ({cardData}) => {
  ...
  return (
    <div id="box-glass2" className="w-[90%] h-[210px]  max-w-[400px]  bg-gradient-to-br from-gray via-gray2 to-gray2 pb-3 py-2 pl-3 pr-1 rounded-xl border border-gray flex flex-col justify-between lg:pt-4 lg:pl-4 lg:pb-4 lg:h-[230px] lg:max-w-[390px] xl:h-[250px] hover:shadow-lg hover:shadow-gray  hover:border-whiteCustom duration-500 group 2xl:max-w-[430px] 2xl:h-[260px]">
