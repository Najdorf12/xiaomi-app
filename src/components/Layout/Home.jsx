...
const Home = () => {
  ...
  return (
    <section className="relative  w-full h-[90vh] lg:h-screen overflow-hidden flex flex-col lg:flex-row lg:justify-center lg:items-center lg:gap-20">
      ...
      <div className="lg:w-[45%] xl:w-[40%] lg:self-start lg:mt-24 ">
      ...
      <figure className="flex justify-center items-center w-full h-[400px] md:h-auto mt-4 lg:mt-0 lg:w-[48%]  2xl:w-[46%]">
        <img
          src={bgHomeMobile}
          alt="Fondo móvil"
