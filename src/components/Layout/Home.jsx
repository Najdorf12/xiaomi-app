  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      >
        ...
        <ul className="flex justify-center font-medium items-center gap-6 font-title text-zinc-200 text-sm xl:text-base xl:gap-9 2xl:text-xl ">
      ...
      >
        ...
        <p className="z-50 font-title mt-2 text-balance font-medium text-base text-zinc-600 lg:text-lg xl:mt-1 xl:text-xl  2xl:text-2xl  ">
        ...
        <div className="w-full font-text2 text-sm flex justify-start items-start mt-5 gap-3  lg:gap-12 lg:mt-4 xl:mt-6 2xl:mt-8">
          <button
            id="box-glass2"
            className="group bg-gradient-to-l from-primary via-gray to-gray text-stone-300 group border-[2px] rounded-3xl font-semibold  border-zinc-500 pl-4 pr-1 py-[1px]  flex justify-between items-center min-w-[170px] md:text-base xl:py-[2px]  lg:border-zinc-400  lg:w-[195px]  duration-500"
          >
            SERVICIO
