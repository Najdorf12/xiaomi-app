...
const About = () => {
  return (
    <>
      <section className="overflow-hidden w-full flex justify-center items-center mt-6  pb-9 lg:pt-0 lg:pb-20 lg:-mt-12 2xl:-mt-20 2xl:pb-28">
        <ul className="z-50  w-full  relative flex justify-center px-3 items-center flex-wrap  gap-x-2 gap-y-5 lg:px-0  lg:gap-0 lg:justify-evenly">
      ...
      <section className="relative  w-full py-6 flex flex-col  justify-center items-center  overflow-hidden   lg:flex-row-reverse lg:items-center  lg:px-3 lg:pb-12 lg:pt-20 lg:-mt-2 xl:pt-20 xl:pb-12">
